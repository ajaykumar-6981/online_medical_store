...
<html>
   ...
   <div class="nav">
         ...
         <ul class="list">
               ...
               <li><a href="#">MEDICINE AVAILABILITY</a></li>
 ...
 <div class="row">
   ...
   <div class="col-lg-4 col-md-12 col-sm-12">    
          ...
          <h5 style='border:2px solid orange'>Customer name:<?php echo($_SESSION['customer_name'])?></h5>
     ...
     <button onclick="document.getElementById('id01').style.display='block'" style="width:100%;margin:auto;">Order Now</button>
</div>
</div>
<div id="id01" class="modal">
		<span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">×</span>
		<form class="modal-content animate" method='POST' action="customer.php">
			<div class="container">
			    <article class="card-body m-auto"> 
          <h5 style='color:green;text-align:center;'><?php echo($_SESSION['customer_name'])?></h5>
			       <h1 style="color:orange;text-align:center;">YOUR MEDICINE ORDER IS IN PROCESS.....</h1>
                    <div class="clearfix">
					   <button type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn">Cancel</button>
				       <button type="submit" class="signupbtn" name="create">OK</button>
				    </div>
				</article>
			</div>
		</form>
