<?php
 ...
 if(isset($_SESSION['username'])){             //if session is set then we don't need to login again
...
if(isset($_POST['submit']))
{
  ...
  $username=mysqli_real_escape_string($con,$_POST['username']);   //use function to make username more secure         
  $password=$_POST['password'];


  $sql="SELECT admin_id,username,firstname FROM admin WHERE username='{$username}' AND password='{$password}'";
 // echo $sql; 
 // die();
...
<section class="bgimage">
  <div class='info'>
   ...
   <a href="c_login.php" style='background-color:white;padding:1px 45px;'>Login for Customer</a>
  </div>
    <div class="container">
      <div class="row">
